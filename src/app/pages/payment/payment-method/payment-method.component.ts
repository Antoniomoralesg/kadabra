    ...
    <div class="bg-white p-6 rounded-xl shadow-xl border">
      ...
      <form (ngSubmit)="nextStep()">
        <div class="mb-4">
          ...
          <div class="flex flex-col gap-4">
            <div class="flex items-center">
              <input type="radio" [(ngModel)]="paymentMethod" name="paymentMethod" value="installments" class="mr-2" required />
              <div>
                <span class="font-bold">Pagar en 3 plazos</span>
                <p class="text-sm">Divide tu compra en 3 pagos sin intereses de 16,33 € (0% TAE)</p>
                <a href="#" class="text-blue-500 text-sm">Cómo funciona</a>
              </div>
            </div>
            <div class="flex items-center">
              <input type="radio" [(ngModel)]="paymentMethod" name="paymentMethod" value="paypal" class="mr-2" required />
              <div class="flex items-center">
            ...
            <div class="flex items-center">
              <input type="radio" [(ngModel)]="paymentMethod" name="paymentMethod" value="creditCard" class="mr-2" required />
              <div>
            ...
            <div class="flex items-center">
              <input type="radio" [(ngModel)]="paymentMethod" name="paymentMethod" value="cashOnDelivery" class="mr-2" required />
              <div>
        ...
        <div class="flex justify-between">
          ...
          <button type="submit" class="bg-orange-500 text-white px-4 py-2 rounded">Siguiente</button>
        </div>
      </form>
    </div>
  `,
